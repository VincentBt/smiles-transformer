...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='../../data_transformers/chembl24_corpus.txt', help='path to th ecorpus')
    parser.add_argument('--out_path', '-o', type=str, default='../../data_transformers/vocab.pkl', help='output file')
